  ...
  >
    ...
    <div class="plan-editor__body">
      <label class="plan-field">
        <span>套餐标识名称</span>
        <el-input v-model="form.name" placeholder="例如: 套餐 F (尊享至尊版)" />
      </label>
      ...
      <section class="plan-editor__ratios">
        ...
        <small>联动精算提示：系统自动保障 [买入比例] 与 [排队比例] 两项权和等于 100% 满仓交割（当前已设定为 {{ form.buyRatio }}% / {{ form.queueRatio }}%）。</small>
      </section>
    </div>
