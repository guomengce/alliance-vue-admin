<template>
  <AuditOverlay :model-value="visible" @update:model-value="$emit('update:visible', $event)" :title="title" :subtitle="subtitle">
    <div class="settlement-detail-overlay">
      ...
      <div class="settlement-detail-overlay__facts">
        ...
        <div class="settlement-detail-overlay__fact-row">
          ...
          <span class="settlement-detail-overlay__fact-value">{{ settlement.orderCount }} 单</span>
        </div>
        <div class="settlement-detail-overlay__fact-row">
        ...
        <div class="settlement-detail-overlay__fact-row">
          <span class="settlement-detail-overlay__fact-label">溢扣平台准备金:</span>
    ...
    <template #footer>
      ...
      <el-button v-if="hasCapacityWarning" type="primary" @click="$emit('force-settle')">人工补发并强制轧平</el-button>
    </template>
  </AuditOverlay>
</template>
